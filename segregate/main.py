...
def go(config: DictConfig):
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": "raw_data.parquet:lastest",
    ...
    if "check_data" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "sample_artifact": "preprocessed.csv:lastest",
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": "preprocessed.csv:lastest",
                "artifact_root": "data",
    ...
    if "random_forest" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "train_data": "data_train.csv:lastest",
